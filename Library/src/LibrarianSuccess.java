...
public class LibrarianSuccess extends JFrame {
	...
	public LibrarianSuccess() {
		...
		JButton btnNewButton = new JButton("Добави книга");
		...
		JButton btnIssueBook = new JButton("Невърната книга");
		...
		JButton btnViewIssuedBooks = new JButton("Виж всички неврнати");
		...
		JButton btnReturnBook = new JButton("Върни книга");
