...
public class BooksForm extends JFrame {
	...
	public BooksForm() {
		...
		JLabel lblAddBooks = new JLabel("Добави книга");
		lblAddBooks.setForeground(Color.GRAY);
		lblAddBooks.setFont(new Font("Tahoma", Font.PLAIN, 18));
		
		JLabel lblCallNo = new JLabel("Каталожен No:");
		
		JLabel lblName = new JLabel("Заглавие:");
		
		JLabel lblAuthor = new JLabel("Автор:");
		
		JLabel lblPublisher = new JLabel("Издател:");
		...
		JButton btnAddBooks = new JButton("Добави");
		btnAddBooks.addActionListener(new ActionListener() {
			...
			if(i>0){
				JOptionPane.showMessageDialog(BooksForm.this,"Книгата беше добавена успешно!");
				LibrarianSuccess.main(new String[]{});
				frame.dispose();
				
			}else{
				JOptionPane.showMessageDialog(BooksForm.this,"Възникна проблем при добавянето!");
			}
			}
		});
