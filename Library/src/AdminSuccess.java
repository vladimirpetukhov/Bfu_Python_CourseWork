...
public class AdminSuccess extends JFrame {
	...
	private static AdminSuccess frame;
	...
	public AdminSuccess() {
		...
		JLabel lblAdminSection = new JLabel("Администрация");
		...
		JButton btnViewLibrarian = new JButton("Библиотекари");
		...
		JButton btnDeleteLibrarian = new JButton("Изтрий библиотекар");
		...
		JButton btnLogout = new JButton("Излез");
