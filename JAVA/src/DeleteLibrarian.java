		...
		btnDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(sid==null||sid.trim().equals("")){
					JOptionPane.showMessageDialog(DeleteLibrarian.this,"Веведете");
				}else{
					int id=Integer.parseInt(sid);
					int i=LibrarianDao.delete(id);
					if(i>0){
						JOptionPane.showMessageDialog(DeleteLibrarian.this,"Записът беще изтрит успешно!");
					}else{
						JOptionPane.showMessageDialog(DeleteLibrarian.this,"Записът не може да бъде изтрит!");
					}
				}
			}
		});
